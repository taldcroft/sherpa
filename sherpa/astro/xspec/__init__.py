...
class XSbapec(XSAdditiveModel):
    ...
    def __init__(self, name='bapec'):
        ...
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.Abundanc, self.Redshift, self.Velocity, self.norm))
...
class XSbexrav(XSAdditiveModel):
    ...
    def __init__(self, name='bexrav'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.Gamma1, self.breakE, self.Gamma2, self.foldE,
                                              self.rel_refl, self.cosIncl, self.abund, self.Fe_abund, self.redshift, self.norm))
...
class XSbexriv(XSAdditiveModel):
    ...
    def __init__(self, name='bexriv'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.Gamma1, self.breakE, self.Gamma2, self.foldE, self.rel_refl,
                                              self.redshift, self.abund, self.Fe_abund, self.cosIncl, self.T_disk, self.xi, self.norm))
...
class XSbkn2pow(XSAdditiveModel):
    ...
    def __init__(self, name='bkn2pow'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.PhoIndx1, self.BreakE1, self.PhoIndx2, self.BreakE2, self.PhoIndx3, self.norm))
...
class XSbvapec(XSAdditiveModel):
    ...
    def __init__(self, name='bvapec'):
        ...
        self.Velocity = Parameter(name, 'Velocity', 0., 0., 1.e6, 0.0, hugeval, 'km/s', True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.He, self.C, self.N, self.O, self.Ne, self.Mg,
                                              self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Redshift, self.Velocity, self.norm))
...
class XSc6mekl(XSAdditiveModel):
    ...
    def __init__(self, name='c6mekl'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.CPcoef1, self.CPcoef2, self.CPcoef3, self.CPcoef4,
                                              self.CPcoef5, self.CPcoef6, self.nH, self.abundanc, self.redshift, self.switch, self.norm))
...
class XSc6pvmkl(XSAdditiveModel):
    ...
    def __init__(self, name='c6pvmkl'):
        ...
        self.switch = Parameter(name, 'switch', 1, 0, 2, 0, 2, alwaysfrozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.CPcoef1, self.CPcoef2, self.CPcoef3, self.CPcoef4, self.CPcoef5, self.CPcoef6, self.nH, self.He, self.C,
                                              self.N, self.O, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.redshift, self.switch, self.norm))
...
class XScemekl(XSAdditiveModel):
    ...
    def __init__(self, name='cemekl'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.alpha, self.Tmax, self.nH, self.abundanc, self.redshift, self.switch, self.norm))
...
class XScevmkl(XSAdditiveModel):
    ...
    def __init__(self, name='cevmkl'):
        ...
        XSAdditiveModel.__init__(self, name, (self.alpha, self.Tmax, self.nH, self.He, self.C, self.N, self.O, self.Ne,
                                              self.Na, self.Mg, self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.redshift, self.switch, self.norm))
...
class XScflow(XSAdditiveModel):
    ...
    def __init__(self, name='cflow'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.slope, self.lowT, self.highT, self.Abundanc, self.redshift, self.norm))
...
class XScompPS(XSAdditiveModel):
    ...
    def __init__(self, name='compps'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kTe, self.EleIndex, self.Gmin, self.Gmax, self.kTbb, self.tauy, self.geom, self.HRcyl, self.cosIncl,
                                              self.cov_frac, self.rel_refl, self.Fe_ab_re, self.Me_ab, self.xi, self.Tdisk, self.Betor10, self.Rin, self.Rout, self.redshift, self.norm))
...
class XScompTT(XSAdditiveModel):
    ...
    def __init__(self, name='comptt'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.redshift, self.T0, self.kT, self.taup, self.approx, self.norm))
...
class XSdisk(XSAdditiveModel):
    ...
    def __init__(self, name='disk'):
        ...
        self.NSmass = Parameter(
            name, 'NSmass', 1.4, .4, 10., 0.0, hugeval, units='Msun', frozen=True)
...
class XSdiskir(XSAdditiveModel):
    ...
    def __init__(self, name='diskir'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT_disk, self.Gamma, self.kT_e,
                                              self.LcLd, self.fin, self.rirr, self.fout, self.logrout, self.norm))
...
class XSdiskline(XSAdditiveModel):
    ...
    def __init__(self, name='diskline'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.LineE, self.Betor10, self.RinM, self.RoutM, self.Incl, self.norm))
...
class XSdiskm(XSAdditiveModel):
    ...
    def __init__(self, name='diskm'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.accrate, self.NSmass, self.Rinn, self.alpha, self.norm))
...
class XSgnei(XSAdditiveModel):
    ...
    def __init__(self, name='gnei'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.Abundanc, self.Tau, self.kT_ave, self.redshift, self.norm))
...
class XSgrad(XSAdditiveModel):
    ...
    def __init__(self, name='grad'):
        ...
        self.refflag = Parameter(
            name, 'refflag', 1.0, -1.0, 1.0, -hugeval, hugeval, alwaysfrozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.D, self.i, self.Mass, self.Mdot, self.TclTef, self.refflag, self.norm))
...
class XSkerrbb(XSAdditiveModel):
    ...
    def __init__(self, name='kerrbb'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.eta, self.a, self.i, self.Mbh,
                                              self.Mdd, self.Dbh, self.hd, self.rflag, self.lflag, self.norm))
...
class XSkerrd(XSAdditiveModel):
    ...
    def __init__(self, name='kerrd'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.distance, self.TcolTeff, self.M, self.Mdot, self.Incl, self.Rin, self.Rout, self.norm))
...
class XSkerrdisk(XSAdditiveModel):
    ...
    def __init__(self, name='kerrdisk'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.lineE, self.Index1, self.Index2,
                                              self.r_brg, self.a, self.Incl, self.Rinms, self.Routms, self.z, self.norm))
...
class XSlaor(XSAdditiveModel):
    ...
    def __init__(self, name='laor'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.lineE, self.Index, self.RinG, self.RoutG, self.Incl, self.norm))
...
class XSlaor2(XSAdditiveModel):
    ...
    def __init__(self, name='laor2'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.lineE, self.Index, self.RinG, self.RoutG, self.Incl, self.Rbreak, self.Index1, self.norm))
...
class XSmeka(XSAdditiveModel):
    ...
    def __init__(self, name='meka'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.nH, self.Abundanc, self.redshift, self.norm))
...
class XSmekal(XSAdditiveModel):
    ...
    def __init__(self, name='mekal'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.nH, self.Abundanc, self.redshift, self.switch, self.norm))
...
class XSmkcflow(XSAdditiveModel):
    ...
    def __init__(self, name='mkcflow'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.lowT, self.highT, self.Abundanc, self.redshift, self.switch, self.norm))
...
class XSnei(XSAdditiveModel):
    ...
    def __init__(self, name='nei'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.Abundanc, self.Tau, self.redshift, self.norm))
...
class XSrnei(XSAdditiveModel):
    ...
    def __init__(self, name='rnei'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.kT_init, self.Abundanc, self.Tau, self.redshift, self.norm))
...
class XSvrnei(XSAdditiveModel):
    ...
    def __init__(self, name='vrnei'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, 10.0, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.kT_init, self.H, self.He, self.C, self.N, self.O,
                                              self.Ne, self.Mg, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Tau, self.redshift, self.norm))
...
class XSvvrnei(XSAdditiveModel):
    ...
    def __init__(self, name='vvrnei'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, 10.0, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.kT_init, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si,
                                              self.P, self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Tau, self.redshift, self.norm))
...
class XSnpshock(XSAdditiveModel):
    ...
    def __init__(self, name='npshock'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT_a, self.kT_b, self.Abundanc, self.Tau_l, self.Tau_u, self.redshift, self.norm))
...
class XSnsa(XSAdditiveModel):
    ...
    def __init__(self, name='nsa'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.LogT_eff, self.M_ns, self.R_ns, self.MagField, self.norm))
...
class XSnsatmos(XSAdditiveModel):
    ...
    def __init__(self, name='nsatmos'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.LogT_eff, self.M_ns, self.R_ns, self.dist, self.norm))
...
class XSnsmax(XSAdditiveModel):
    ...
    def __init__(self, name='nsmax'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.logTeff, self.redshift, self.specfile, self.norm))
...
class XSnsmaxg(XSAdditiveModel):
    ...
    def __init__(self, name='nsmaxg'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.logTeff, self.M_ns, self.R_ns, self.dist, self.specfile, self.norm))
...
class XSnteea(XSAdditiveModel):
    ...
    def __init__(self, name='nteea'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.l_nth, self.l_bb, self.f_refl, self.kT_bb, self.g_max, self.l_th, self.tau_p,
                                              self.G_inj, self.g_min, self.g_0, self.radius, self.pair_esc, self.cosIncl, self.Fe_abund, self.redshift, self.norm))
...
class XSnthComp(XSAdditiveModel):
    ...
    def __init__(self, name='nthcomp'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.Gamma, self.kT_e, self.kT_bb, self.inp_type, self.redshift, self.norm))
...
class XSpexrav(XSAdditiveModel):
    ...
    def __init__(self, name='pexrav'):
        ...
        self.cosIncl = Parameter(name, 'cosIncl', 0.45, 0.05, 0.95, 0.0, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.PhoIndex, self.foldE, self.rel_refl,
                                              self.redshift, self.abund, self.Fe_abund, self.cosIncl, self.norm))
...
class XSplcabs(XSAdditiveModel):
    ...
    def __init__(self, name='plcabs'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.nH, self.nmax, self.FeAbun, self.FeKedge,
                                              self.PhoIndex, self.HighECut, self.foldE, self.acrit, self.FAST, self.redshift, self.norm))
...
class XSpshock(XSAdditiveModel):
    ...
    def __init__(self, name='pshock'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT, self.Abundanc, self.Tau_l, self.Tau_u, self.redshift, self.norm))
...
class XSrefsch(XSAdditiveModel):
    ...
    def __init__(self, name='refsch'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.PhoIndex, self.foldE, self.rel_refl, self.redshift, self.abund,
                                              self.Fe_abund, self.Incl, self.T_disk, self.xi, self.Betor10, self.Rin, self.Rout, self.accuracy, self.norm))
...
class XSsedov(XSAdditiveModel):
    ...
    def __init__(self, name='sedov'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kT_a, self.kT_b, self.Abundanc, self.Tau, self.redshift, self.norm))
...
class XSvapec(XSAdditiveModel):
    ...
    def __init__(self, name='vapec'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.He, self.C, self.N, self.O, self.Ne, self.Mg,
                                              self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.redshift, self.norm))
...
class XSvequil(XSAdditiveModel):
    ...
    def __init__(self, name='vequil'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.He, self.C, self.N, self.O, self.Ne,
                                              self.Mg, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.redshift, self.norm))
...
class XSvgnei(XSAdditiveModel):
    ...
    def __init__(self, name='vgnei'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.C, self.N, self.O, self.Ne, self.Mg,
                                              self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Tau, self.kT_ave, self.redshift, self.norm))
...
class XSvvgnei(XSAdditiveModel):
    ...
    def __init__(self, name='vvgnei'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.P,
                                              self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Tau, self.kT_ave, self.redshift, self.norm))
...
class XSvmeka(XSAdditiveModel):
    ...
    def __init__(self, name='vmeka'):
        ...
        XSAdditiveModel.__init__(self, name, (self.kT, self.nH, self.He, self.C, self.N, self.O, self.Ne, self.Na,
                                              self.Mg, self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.redshift, self.norm))
...
class XSvmekal(XSAdditiveModel):
    ...
    def __init__(self, name='vmekal'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.nH, self.He, self.C, self.N, self.O, self.Ne, self.Na,
                                              self.Mg, self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.redshift, self.switch, self.norm))
...
class XSvnei(XSAdditiveModel):
    ...
    def __init__(self, name='vnei'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.C, self.N, self.O, self.Ne,
                                              self.Mg, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Tau, self.redshift, self.norm))
...
class XSvvnei(XSAdditiveModel):
    ...
    def __init__(self, name='vvnei'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.P,
                                              self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Tau, self.redshift, self.norm))
...
class XSvnpshock(XSAdditiveModel):
    ...
    def __init__(self, name='vnpshock'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT_a, self.kT_b, self.H, self.He, self.C, self.N, self.O, self.Ne,
                                              self.Mg, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Tau_l, self.Tau_u, self.redshift, self.norm))
...
class XSvvnpshock(XSAdditiveModel):
    ...
    def __init__(self, name='vvnpshock'):
        ...
        self.Cu = Parameter(name, 'Cu', 1., 0., 1000., 0.0, 10000.0, frozen=True)
        self.Zn = Parameter(name, 'Zn', 1., 0., 1000., 0.0, 10000.0, frozen=True)
        self.Tau_l = Parameter(
            name, 'Tau_l', 0.0, 0.0, 5.0e13, 0.0, 5.0e13, units='s/cm^3', frozen=True)
        self.Tau_u = Parameter(name, 'Tau_u', 1.0e11, 1.0e8, 5.0e13, 1.0e8, 5.0e13, units='s/cm^3')
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT_a, self.kT_b, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.P,
                                              self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Tau_l, self.Tau_u, self.redshift, self.norm))
...
class XSvpshock(XSAdditiveModel):
    ...
    def __init__(self, name='vpshock'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.C, self.N, self.O, self.Ne, self.Mg,
                                              self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Tau_l, self.Tau_u, self.redshift, self.norm))
...
class XSvvpshock(XSAdditiveModel):
    ...
    def __init__(self, name='vvpshock'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.P, self.S,
                                              self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Tau_l, self.Tau_u, self.redshift, self.norm))
...
class XSvsedov(XSAdditiveModel):
    ...
    def __init__(self, name='vsedov'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT_a, self.kT_b, self.H, self.He, self.C, self.N, self.O,
                                              self.Ne, self.Mg, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Tau, self.redshift, self.norm))
...
class XSvvsedov(XSAdditiveModel):
    ...
    def __init__(self, name='vvsedov'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, 10.0, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT_a, self.kT_b, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si,
                                              self.P, self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Tau, self.redshift, self.norm))
...
class XSabsori(XSMultiplicativeModel):
    ...
    def __init__(self, name='absori'):
        ...
        XSMultiplicativeModel.__init__(
            self, name, (self.PhoIndex, self.nH, self.Temp_abs, self.xi, self.redshift, self.Fe_abund))
...
class XSacisabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='acisabs'):
        ...
        XSMultiplicativeModel.__init__(
            self, name, (self.Tdays, self.norm, self.tauinf, self.tefold, self.nC, self.nH, self.nO, self.nN))
...
class XScyclabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='cyclabs'):
        ...
        XSMultiplicativeModel.__init__(
            self, name, (self.Depth0, self.E0, self.Width0, self.Depth2, self.Width2))
...
class XShrefl(XSMultiplicativeModel):
    ...
    def __init__(self, name='hrefl'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(
            self, name, (self.thetamin, self.thetamax, self.thetaobs, self.Feabun, self.FeKedge, self.Escfrac, self.covfac, self.redshift))
...
class XSsmedge(XSMultiplicativeModel):
    ...
    def __init__(self, name='smedge'):
        ...
        XSMultiplicativeModel.__init__(
            self, name, (self.edgeE, self.MaxTau, self.index, self.width))
...
class XSspline(XSMultiplicativeModel):
    ...
    def __init__(self, name='spline'):
        ...
        XSMultiplicativeModel.__init__(
            self, name, (self.Estart, self.Ystart, self.Yend, self.YPstart, self.YPend, self.Eend))
...
class XSswind1(XSMultiplicativeModel):
    ...
    def __init__(self, name='swind1'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(
            self, name, (self.column, self.logxi, self.sigma, self.redshift))
...
class XSTBgrain(XSMultiplicativeModel):
    ...
    def __init__(self, name='tbgrain'):
        ...
        XSMultiplicativeModel.__init__(
            self, name, (self.nH, self.h2, self.rho, self.amin, self.amax, self.PL))
...
class XSTBvarabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='tbvarabs'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(self, name, (self.nH, self.He, self.C, self.N, self.O, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.S, self.Cl, self.Ar, self.Ca, self.Cr, self.Fe, self.Co, self.Ni, self.H2, self.rho, self.amin, self.amax, self.PL,
                                                    self.H_dep, self.He_dep, self.C_dep, self.N_dep, self.O_dep, self.Ne_dep, self.Na_dep, self.Mg_dep, self.Al_dep, self.Si_dep, self.S_dep, self.Cl_dep, self.Ar_dep, self.Ca_dep, self.Cr_dep, self.Fe_dep, self.Co_dep, self.Ni_dep, self.redshift))
...
class XSvarabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='varabs'):
        ...
        XSMultiplicativeModel.__init__(self, name, (self.H, self.He, self.C, self.N, self.O, self.Ne, self.Na,
                                                    self.Mg, self.Al, self.Si, self.S, self.Cl, self.Ar, self.Ca, self.Cr, self.Fe, self.Co, self.Ni))
...
class XSvphabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='vphabs'):
        ...
        self.Ni = Parameter(name, 'Ni', 1., 0., 1000., 0.0, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(self, name, (self.nH, self.He, self.C, self.N, self.O, self.Ne, self.Na,
                                                    self.Mg, self.Al, self.Si, self.S, self.Cl, self.Ar, self.Ca, self.Cr, self.Fe, self.Co, self.Ni))
...
class XSxion(XSMultiplicativeModel):
    ...
    def __init__(self, name='xion'):
        ...
        XSMultiplicativeModel.__init__(self, name, (self.height, self.lxld, self.rate, self.cosAng, self.inner,
                                                    self.outer, self.index, self.redshift, self.Feabun, self.E_cut, self.Ref_type, self.Rel_smear, self.Geometry))
...
class XSzxipcf(XSMultiplicativeModel):
    ...
    def __init__(self, name='zxipcf'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(
            self, name, (self.Nh, self.logxi, self.CvrFract, self.redshift))
...
class XSzsmdust(XSMultiplicativeModel):
    ...
    def __init__(self, name='zsmdust'):
        ...
        self.redshift = Parameter(name, 'redshift', 0.0, 0.0, 20., 0.0, hugeval, 'z', True)
        XSMultiplicativeModel.__init__(
            self, name, (self.EBV, self.ExtIndex, self.Rv, self.redshift))
...
class XSzvarabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='zvarabs'):
        ...
        self.Ni = Parameter(name, 'Ni', 1., 0., 1000., 0.0, hugeval, 'sNi22', True)
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(self, name, (self.H, self.He, self.C, self.N, self.O, self.Ne, self.Na, self.Mg,
                                                    self.Al, self.Si, self.S, self.Cl, self.Ar, self.Ca, self.Cr, self.Fe, self.Co, self.Ni, self.redshift))
...
class XSzvfeabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='zvfeabs'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(
            self, name, (self.nH, self.metals, self.FEabun, self.FEKedge, self.redshift))
...
class XSzvphabs(XSMultiplicativeModel):
    ...
    def __init__(self, name='zvphabs'):
        ...
        self.Ni = Parameter(name, 'Ni', 1., 0., 1000., 0.0, hugeval, frozen=True)
        self.redshift = Parameter(name, 'redshift', 0., -0.999, 10., -0.999, hugeval, frozen=True)
        XSMultiplicativeModel.__init__(self, name, (self.nH, self.He, self.C, self.N, self.O, self.Ne, self.Na, self.Mg,
                                                    self.Al, self.Si, self.S, self.Cl, self.Ar, self.Ca, self.Cr, self.Fe, self.Co, self.Ni, self.redshift))
...
class XScplinear(XSAdditiveModel):
    ...
    def __init__(self, name='cplinear'):
        self.energy00 = Parameter(
            name, 'energy00', 0.5, min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy01 = Parameter(
            name, 'energy01', 1., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy02 = Parameter(
            name, 'energy02', 1.5, min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy03 = Parameter(
            name, 'energy03', 2., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy04 = Parameter(
            name, 'energy04', 3., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy05 = Parameter(
            name, 'energy05', 4., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy06 = Parameter(
            name, 'energy06', 5., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy07 = Parameter(
            name, 'energy07', 6., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy08 = Parameter(
            name, 'energy08', 7., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.energy09 = Parameter(
            name, 'energy09', 8., min=0.0, max=10.0, units='keV', alwaysfrozen=True)
        self.log_rate00 = Parameter(
            name, 'log_rate00', 0., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate01 = Parameter(
            name, 'log_rate01', 1., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate02 = Parameter(
            name, 'log_rate02', 0., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate03 = Parameter(
            name, 'log_rate03', 1., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate04 = Parameter(
            name, 'log_rate04', 0., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate05 = Parameter(
            name, 'log_rate05', 1., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate06 = Parameter(
            name, 'log_rate06', 0., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate07 = Parameter(
            name, 'log_rate07', 1., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate08 = Parameter(
            name, 'log_rate08', 0., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.log_rate09 = Parameter(
            name, 'log_rate09', 1., -19.0, 19.0, -hugeval, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.energy00, self.energy01, self.energy02, self.energy03, self.energy04, self.energy05, self.energy06, self.energy07, self.energy08, self.energy09,
                                              self.log_rate00, self.log_rate01, self.log_rate02, self.log_rate03, self.log_rate04, self.log_rate05, self.log_rate06, self.log_rate07, self.log_rate08, self.log_rate09, self.norm))
...
class XSeqpair(XSAdditiveModel):
    ...
    def __init__(self, name='eqpair'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.l_hl_s, self.l_bb, self.kT_bb, self.l_ntl_h, self.tau_p, self.radius, self.g_min, self.g_max, self.G_inj,
                                              self.pairinj, self.cosIncl, self.Refl, self.Fe_abund, self.AbHe, self.T_disk, self.xi, self.Beta, self.Rin, self.Rout, self.redshift, self.norm))
...
class XScompth(XSAdditiveModel):
    ...
    def __init__(self, name='compth'):
        ...
        self.redshift = Parameter(name, 'redshift', 0., 0., 4., 0.0, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.theta, self.showbb, self.kT_bb, self.RefOn, self.tau_p, self.radius, self.g_min, self.g_max, self.G_inj,
                                              self.pairinj, self.cosIncl, self.Refl, self.Fe_abund, self.AbHe, self.T_disk, self.xi, self.Beta, self.Rin, self.Rout, self.redshift, self.norm))
...
class XSbvvapec(XSAdditiveModel):
    ...
    def __init__(self, name='bvvapec'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si, self.P,
                                              self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Redshift, self.Velocity, self.norm))
...
class XSvvapec(XSAdditiveModel):
    ...
    def __init__(self, name='vvapec'):
        ...
        self.Redshift = Parameter(name, 'Redshift', 0., -0.999, 10., -hugeval, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kT, self.H, self.He, self.Li, self.Be, self.B, self.C, self.N, self.O, self.F, self.Ne, self.Na, self.Mg, self.Al, self.Si,
                                              self.P, self.S, self.Cl, self.Ar, self.K, self.Ca, self.Sc, self.Ti, self.V, self.Cr, self.Mn, self.Fe, self.Co, self.Ni, self.Cu, self.Zn, self.Redshift, self.norm))
...
class XSgadem(XSAdditiveModel):
    ...
    def __init__(self, name='gadem'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.Tmean, self.Tsigma, self.nH, self.abundanc, self.Redshift, self.switch, self.norm))
...
class XSvgadem(XSAdditiveModel):
    ...
    def __init__(self, name='vgadem'):
        ...
        self.switch = Parameter(name, 'switch', 2, 0, 2, 0, 2, alwaysfrozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.Tmean, self.Tsigma, self.nH, self.He, self.C, self.N, self.O, self.Ne,
                                              self.Na, self.Mg, self.Al, self.Si, self.S, self.Ar, self.Ca, self.Fe, self.Ni, self.Redshift, self.switch, self.norm))
...
class XSoptxagn(XSAdditiveModel):
    ...
    def __init__(self, name='optxagn'):
        ...
        XSAdditiveModel.__init__(self, name, (self.mass, self.dist, self.logLLEdd, self.astar, self.rcor,
                                              self.logrout, self.kT_e, self.tau, self.Gamma, self.fpl, self.fcol, self.tscat, self.Redshift, self.norm))
...
class XSoptxagnf(XSAdditiveModel):
    ...
    def __init__(self, name='optxagnf'):
        ...
        self.Redshift = Parameter(name, 'Redshift', 0., 0., 10., 0.0, hugeval, frozen=True)
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval, frozen=True)
        XSAdditiveModel.__init__(self, name, (self.mass, self.dist, self.logLLEdd, self.astar,
                                              self.rcor, self.logrout, self.kT_e, self.tau, self.Gamma, self.fpl, self.Redshift, self.norm))
...
class XSpexmon(XSAdditiveModel):
    ...
    def __init__(self, name='pexmon'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.PhoIndex, self.foldE, self.rel_refl,
                                              self.redshift, self.abund, self.Fe_abund, self.Incl, self.norm))
...
class XScompmag(XSAdditiveModel):
    ...
    def __init__(self, name='compmag'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(self, name, (self.kTbb, self.kTe, self.tau,
                                              self.eta, self.beta0, self.r0, self.A, self.betaflag, self.norm))
...
class XScomptb(XSAdditiveModel):
    ...
    def __init__(self, name='comptb'):
        ...
        self.norm = Parameter(name, 'norm', 1.0, 0.0, 1.0e24, 0.0, hugeval)
        XSAdditiveModel.__init__(
            self, name, (self.kTs, self.gamma, self.alpha, self.delta, self.kTe, self.log_A, self.norm))
